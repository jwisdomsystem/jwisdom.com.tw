...
export default function NewsIndex({ items, categories, filters }: { items: Paginated; categories: string[]; filters: Filters }) {
    return <ContentList kind="news" items={items} categories={categories} filters={filters} />;
}
